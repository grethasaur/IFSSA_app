...
def exploratory_data_analysis():
    ...
    tableau_embed_code = """
    <div class='tableauPlaceholder' id='viz1734066917606' style='position: relative'>
        <noscript><a href='#'>
            <img alt='Dash1 ' src='https://public.tableau.com/static/images/Wo/WorkIntegratedllDashboard/Dash1/1_rss.png' style='border: none' />
        </a></noscript>
        <object class='tableauViz' style='display:none;'>
            <param name='host_url' value='https%3A%2F%2Fpublic.tableau.com%2F' />
            <param name='embed_code_version' value='3' />
            <param name='site_root' value='' />
            <param name='name' value='WorkIntegratedllDashboard%2FDash1' />
            <param name='tabs' value='no' />
            <param name='toolbar' value='yes' />
            <param name='static_image' value='https://public.tableau.com/static/images/Wo/WorkIntegratedllDashboard/Dash1/1.png' />
    ...
    <script type='text/javascript'>
        var divElement = document.getElementById('viz1734066917606');
    ...
    components.html(tableau_embed_code, height=827)
